...
iteration is new.  For a primitive triple with odd \(c\), the exact
one-step formula
\[
...
retrieval, coding assistance, drafting, and adversarial cross-review
during manuscript development.  Anthropic Claude Opus~5 was used for
the final independent pull-request review.  These systems were used to
accelerate exploration and to expose errors through independent
cross-checking.  Mathematical claims were
