...
\begin{quote}\small
Working-draft note (2026-07-30): commit \texttt{6bf6864} preserves the proposal
...
\textbf{Status.} This is a research-development draft, not a peer-reviewed
...
\emph{2020 Mathematics Subject Classification.} Primary 11B39; Secondary 11A05,
11D75, 11J86, 37P05.

\emph{Keywords.} \(abc\) conjecture, Chebyshev polynomial, Lucas sequence,
...
\section{The prime-degree transfer}
...
\subsection{\texorpdfstring{Lemma 1: Parity and \(\ell\)-adic normalization}{Lemma 1: Parity and ell-adic normalization}}
...
\subsection{Lemma 2: Primitivity and local support exclusion}
...
\subsection{Theorem 3: Branchwise prime genealogy}
...
\section{Chebyshev dynamics and the radical telescope}
...
\subsection{Lemma 4: Chebyshev semiconjugacy}
...
\subsection{Theorem 5: Exact prime-degree radical identity}
...
\subsection{Proposition 6: Strict radical monotonicity}
...
\subsection{Corollary 8: Exact quality criterion}
...
\section{Cyclotomic Lucas factors and level primes}
...
\subsection{Proposition 9: Two interleaved Lucas-atom towers}
...
\subsection{Proposition 10: Branch order}
...
\subsection{Proposition 11: Signed branch Wieferich lifts}
...
\subsection{Proposition 12: Prime-power cyclotomic factorization}
...
\subsection{Theorem 13: Exact level and prime congruence}
...
\subsection{Proposition 14: Cyclotomic Wieferich criterion}
...
\section{Local classification and exact realization of prime genealogies}
...
\subsection{Fibotomic bridge and prior-art position}
...
\subsection{Proposition 15: Local root classification}
...
\subsection{Corollary 16: Exact local valuation}
...
\subsection{Theorem 17: Simultaneous finite genealogy realization}
...
\begin{itemize}
\item the \(p_i\) are distinct odd primes different from \(\ell\);
\item \(n_i\geq0\);
\item \(h_i\geq1\);
\item \(\varepsilon_i\in\{A,B\}\);
\item \(\chi_i\in\{1,-1\}\).
\end{itemize}
...
\subsection{Remark 18: A programmed square}
...
\subsection{Corollary 19: Unbounded fixed-level defect across seeds}
...
\section{A bounded local mean over primitive seed boxes}
...
\subsection{Theorem 20: Exact local first moment}
...
\subsection{Large-square obstruction}
...
\section{A canonical family for every odd prime}

\subsection{Corollary 21: Uniform explicit hit orbits}
...
\subsection{Conjecture 22: Subpower repeated-prime growth}
...
of Lucas atoms and their \(p\)-adic valuations," \emph{Monatshefte fur
...
fields," \emph{Finite Fields and Their Applications} \textbf{5} (1999), 103-111.

\url{https://doi.org/10.1006/ffta.1998.0221}

A. Baker and G. Wustholz, "Logarithmic forms and group varieties,"
\emph{Journal fur die reine und angewandte Mathematik} \textbf{442} (1993), 19-62.

\url{https://doi.org/10.1515/crll.1993.442.19}

Y. Bilu, G. Hanrot, and P. M. Voutier, "Existence of primitive divisors of
Lucas and Lehmer numbers," \emph{Journal fur die reine und angewandte
Mathematik} \textbf{539} (2001), 75-122.

\url{https://doi.org/10.1515/crll.2001.080}

A. W. Bluher, "Permutation properties of Dickson and Chebyshev polynomials
with connections to number theory," \emph{Finite Fields and Their Applications}
\textbf{76} (2021), 101899.

\url{https://doi.org/10.1016/j.ffa.2021.101899}
...
T. A. Gassert, "Chebyshev action on finite fields," \emph{Discrete
Mathematics} \textbf{315} (2014), 83-94.

\url{https://doi.org/10.1016/j.disc.2013.10.014}

B. Poonen, "Squarefree values of multivariable polynomials," \emph{Duke
Mathematical Journal} \textbf{118} (2003), 353-373.
...
\url{https://doi.org/10.48550/arXiv.2512.03468}

L. J. Ratliff, Jr., D. E. Rush, and K. Shah, "Note on cyclotomic
polynomials and prime ideals," \emph{Communications in Algebra} \textbf{32} (2004),
333-343.
...
\url{https://doi.org/10.48550/arXiv.2605.24909}

G. Martin and W. Miao, "\(abc\) triples," \emph{Functiones et Approximatio
Commentarii Mathematici} \textbf{55} (2016), 145-176.

\url{https://doi.org/10.7169/facm/2016.55.2.2}

B. E. Sagan and J. P. Tirrell, "Lucas atoms," \emph{Advances in Mathematics}
\textbf{374} (2020), 107387.
...
S. Y. Xiao, "Square-free values of decomposable forms," \emph{Canadian Journal
of Mathematics} \textbf{70} (2018), 1390-1415.

\url{https://doi.org/10.4153/CJM-2017-060-4}
\end{document}
