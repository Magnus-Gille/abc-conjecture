...
\]
listed as OEIS A025172~\cite{OEIS-A025172}; the Chebyshev form also
occurs in~\cite{BajorskaEtAl2019}.  Pairwise coprimality at dyadic
indices, rank congruences, and the individual Lucas--Wieferich criterion
are standard consequences of Lucas-sequence theory
\cite{Ribenboim2001,Sun2013}.  The orbit identity, its telescoped
...
\cite{OEIS-A025172,BajorskaEtAl2019}.
...
\]
Indeed, for the roots \(\alpha,\beta\) above,
...
\bibitem{BajorskaEtAl2019}
B.~Bajorska-Harapi\'nska, B.~Smole\'n, and R.~Witu{\l}a,
\newblock On quaternion equivalents for quasi-Fibonacci numbers, shortly
quaternaccis,
\newblock \emph{Advances in Applied Clifford Algebras} \textbf{29} (2019),
Article 54.
\newblock \url{https://doi.org/10.1007/s00006-019-0969-9}.
...
\newblock
\url{https://www.universiteitleiden.nl/binaries/content/assets/science/mi/scripties/vanderhorstmaster.pdf}.
